...
**budget_category_id** | Option<[**uuid::Uuid**](uuid::Uuid.md)> |  | [optional]
**color** | Option<[**models::TypesColor**](types.Color.md)> |  | [optional]
**created** | Option<**String**> |  | [optional]
**icon** | Option<**String**> |  | [optional]
**id** | Option<[**uuid::Uuid**](uuid::Uuid.md)> |  | [optional]
**labels_values_ids** | Option<**Vec<String>**> |  | [optional]
**name** | Option<**String**> |  | [optional]
**parent_id** | Option<[**uuid::Uuid**](uuid::Uuid.md)> |  | [optional]
**plan_task_count** | Option<**i32**> |  | [optional]
**plan_task_sort** | Option<**String**> |  | [optional]
**position** | Option<**String**> |  | [optional]
**shop_item_count** | Option<**i32**> |  | [optional]
